...
var pool = module.exports = function pool(options, authorizeFn)
{
    ...
    function OutputPoolInfo() {
        ...
        if (typeof options.blockRefreshInterval === "number" && options.blockRefreshInterval > 0) { infoLines.push('Block polling every:\t' + options.blockRefreshInterval + ' ms'); }
        ...
        _this.stratumServer.on('started', function() {
            ...
            client.on('difficultyChanged', function(diff) {
                ...
                */
                ...
                emitErrorLog('Socket disconnected from ' + client.getLabel());
